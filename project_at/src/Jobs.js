    ...
    return (
        ...
        <div className="card mb-4">
            <div className="card-header">
                ...
                <button id="openBtn" className="float-lg-end  btn btn-outline-dark">Open Notepad</button>
                <span className="float-lg-end">&nbsp;&nbsp;&nbsp;</span>
                {/* Button to open the job form */}
                <button id="myButton" className="float-lg-end  btn btn-outline-dark submit-button">Documents
                    Application
                </button>
                {/* The overlay */}
